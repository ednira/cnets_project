...
def import_log(path, profile=None):
    ...
    try:
        ...
        return ocel, ocel_df, ot_activities, activity_to_object_types, obj_to_obj, event_to_obj
...
def ot_cardinalities(obj_to_obj, event_to_obj, ot_activities):
    ...
    return cardinalities, ot1_ot2_cardinalities, ot2_ot1_cardinalities, relations
...
def ot_sequence(ot_activities, ot1_ot2_cardinalities, ot2_ot1_cardinalities, event_to_obj):
    ...
    # Function to check in the potential_next which ot c
    ...
    return partially_common, totally_common, ot_sequence