...
- **demo**:  a **[Jupyter notebook](./object-centric/demonstration)** implements the method described in the paper and interactively provides a step-by-step demonstration of the main features.
